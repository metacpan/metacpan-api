...
is(MetaCPAN::Util::strip_pod('hello L<link|http://www.google.com> foo'), 'hello link <http://www.google.com> foo');
...
is(MetaCPAN::Util::strip_pod('B<bold> I<italics> C<code> F<file>'),
	'bold italics code file', 'character formatting stripped');
is(MetaCPAN::Util::strip_pod('E<lt>me@example.comE<gt>'),
	'<me@example.com>', 'POD escapes decoded');
is(MetaCPAN::Util::strip_pod("Para one.\n\nPara\ntwo.\n\nPara     three.\n"),
	"Para one.\nPara two.\nPara three.", 'whitespace collapsed, paras as lines');
is(MetaCPAN::Util::strip_pod("Para one.\n\n  verbatim a\n  verbatim     b\nPara     two.\n"),
	"Para one.\nverbatim a\nverbatim b\nPara two.", 'verbatim lines not wrapped');
is(MetaCPAN::Util::strip_pod("=encoding utf8\n\nMoose - \xC3\x89lan\n"),
	"Moose - Élan", 'utf8 bytes decoded');
is(MetaCPAN::Util::strip_pod("Moose - \xC3\x89lan\n"),
	"Moose - Élan", 'utf8 bytes decoded - even without encoding declaration');
is(MetaCPAN::Util::strip_pod("=encoding iso8859-1\n\nMoose - \xC9lan\n"),
	"Moose - Élan", 'Latin1 bytes decoded');
is(MetaCPAN::Util::strip_pod("Moose - \xC9lan\n"),
	"Moose - Élan", 'Latin1 bytes decoded - even without encoding declaration');
is(MetaCPAN::Util::strip_pod("=encoding CP1252\n\nMoose \x96\x97 \x91\xC9lan\x92 \x93Dou\xE9\x94"),
	"Moose –— ‘Élan’ “Doué”", 'CP1252 bytes decoded');
is(MetaCPAN::Util::strip_pod("Moose \x96\x97 \x91\xC9lan\x92 \x93Dou\xE9\x94"),
	"Moose -- 'Élan' \"Doué\"", 'CP1252 bytes de-smarted without encoding declaration');
is(MetaCPAN::Util::strip_pod("=encoding iso8859-2\n\nAlien::Not - \xD2\xF4\xFE \xE3\xF1 \xB1\xE5\xED\xEA\xF2"),
	"Alien::Not - Ňôţ ăń ąĺíęň", 'strip_pod honoured latin2 encoding');
...
EOF
	...
	like($formatted, qr/Some::Thing - Somethin’ or nothin’/,
	...
	like($formatted, qr/This is meant to be “descriptive”./,
	    'POD parser was able to decode bytes');
