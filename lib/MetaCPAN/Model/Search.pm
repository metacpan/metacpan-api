...
# This was an attempt at a totally new query but nees lots of
# work to make the xt/search_web.t pass
# May need a different querty for non-collapsed (anything
# that uses lucen syndax, e.g. module:foo)
sub build_query_attemt_at_new_query {
